...
$(document).ready(function () {
  ...
  if($('.quick_view_carousel_holder').length != 0){
	...
	//hide the arrow button when there are more thumbnails.
	var thumbs = $('#quick_view_product_carousel li');
	if(thumbs.length<4){
  		$('#quick_view_carousel').css('display','none');
  	}else if(thumbs.length<7){
